...
((Drupal, once, tabbable) => {
  ...
  function init(props) {
    ...
    document.addEventListener('keyup', (e) => {
      if (e.key === 'Escape' || e.key === 'Esc') {
        if (props.slivero.areAnySubNavsOpen()) {
          props.slivero.closeAllSubNav();
        } else {
   ...
   */
  Drupal.behaviors.sliveroNavigation = {
    attach(context) {
