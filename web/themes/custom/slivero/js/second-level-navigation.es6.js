...
((Drupal) => {
  const { isDesktopNav } = Drupal.slivero;
  ...
  Drupal.slivero.toggleSubNav = toggleSubNav;
  ...
  function handleBlur(e) {
    if (!Drupal.slivero.isDesktopNav()) return;
  ...
  Drupal.slivero.closeAllSubNav = closeAllSubNav;
  ...
  Drupal.slivero.areAnySubNavsOpen = areAnySubNavsOpen;
