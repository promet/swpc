...
((Drupal) => {
  ...
  Drupal.slivero.isDesktopNav = isDesktopNav;
  ...
  function setStickyHeaderStorage(expandedState) {
    ...
    localStorage.setItem(
      'Drupal.slivero.stickyHeaderState',
      JSON.stringify(item),
    );
  }
  ...
  function getStickyHeaderStorage() {
    ...
    if (now.getTime() > item.expiry) {
      ...
      localStorage.removeItem('Drupal.slivero.stickyHeaderState');
      return false;
    }
    return item.value;
  }
