 ...
 * @endcode
 */
$settings['hash_salt'] = 'sueU1XmrEhIDAId8-8o6XTGgnfBL73ZbSAc9LKAJGJRH1XyVABikT1QTUH1Mfpz2GtQiMO0kOw';
...
/**
 * For local development DB connectivity.
 */
if (file_exists($app_root . '/' . $site_path . '/settings.local.php')) {
  include $app_root . '/' . $site_path . '/settings.local.php';
}
...
/**
 * Use this for hosting env and don't check it into git ever.
 */
if (file_exists($app_root . '/' . $site_path . '/settings.hosting.php')) {
  include $app_root . '/' . $site_path . '/settings.hosting.php';
}

// Drupal config import / export location.
